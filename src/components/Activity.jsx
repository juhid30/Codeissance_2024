          ...
          <div className="w-full h-full bg-[#f2f4f3] flex">
              ...
              <div className="h-[25%] m-[1%] flex">
                ...
                <div className="w-[25%] m-[0.5%] border border-[#e7e7e7] relative overflow-hidden rounded-[30px] flex flex-col items-center ">
                  <img
                    ...
                    src={fries}
                  ></img>
                  <div className="h-[30%] w-[100%] flex items-center justify-center font-medium bg-[#F57D98]">
                    {" "}
                    Food{" "}
                  </div>
                ...
                <div className="w-[25%] m-[0.5%] border border-[#e7e7e7] relative overflow-hidden rounded-[30px] flex flex-col items-center ">
                  <img
                    ...
                    src={money}
                  ></img>
                  <div className="h-[30%] w-[100%] flex items-center justify-center font-medium bg-[#4FD9C5]">
                    {" "}
                    Bills{" "}
                  </div>
                  <div className="h-[70%] w-[100%] flex items-center justify-center text-[18px] z-[1]">
                ...
                <div className="w-[25%] m-[0.5%] border border-[#e7e7e7] relative overflow-hidden rounded-[30px] flex flex-col items-center">
                  <img
                    ...
                    src={tickets}
                  ></img>
                  <div className="h-[30%] w-[100%] flex items-center justify-center font-medium bg-[#58BDE7]">
                    {" "}
                    Logistics{" "}
                  </div>
                  <div className="h-[70%] w-[100%] flex items-center justify-center text-[18px] z-[1]">
                ...
                <div className="w-[25%] m-[0.5%] border border-[#e7e7e7] relative overflow-hidden rounded-[30px] flex flex-col items-center">
                  <img
                    ...
                    src={books}
                  ></img>
                  <div className="h-[30%] w-[100%] flex items-center justify-center font-medium bg-[#518EE0]">
                    {" "}
                    Misc{" "}
                  </div>
                  <div className="h-[70%] w-[100%] flex items-center justify-center text-[18px] z-[1]">
            ...
            <div className="w-[30%] h-full m-[1%] flex flex-col ">
              ...
              <div className="w-full flex justify-around p-4">
                <button
                  className="px-4 py-2 bg-[#518EE0] text-white rounded-md"
