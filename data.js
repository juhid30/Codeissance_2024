...
const products = [
  ...
  // Additional Products
  {
    ...
    name: "Emergency Blankets",
    category: "Shelter and Clothing",
    description: "Durable emergency blankets ideal for extreme weather conditions.",
    cost: 18.0,
    supplier_id: "supplier_005",
    quantity_available: 150,
    image_url: "http://example.com/images/emergency_blankets_v2.jpg",
  },
  {
    id: "prod_012",
    name: "Water Purification Tablets",
    category: "Health and Hygiene",
    description: "Efficient water purification tablets for safe drinking water.",
    cost: 6.0,
    supplier_id: "supplier_006",
    quantity_available: 400,
    image_url: "http://example.com/images/water_purification_tablets_v2.jpg",
  },
  {
    id: "prod_013",
    name: "Solar Lanterns",
    category: "Safety and Emergency",
    description: "Portable solar lanterns designed for outdoor adventures.",
    cost: 35.0,
    supplier_id: "supplier_007",
    quantity_available: 80,
    image_url: "http://example.com/images/solar_lanterns_v2.jpg",
  },
  {
    id: "prod_014",
    name: "First Aid Supplies",
    category: "Health and Hygiene",
    description: "Comprehensive first aid kit with essential items.",
    cost: 22.0,
    supplier_id: "supplier_005",
    quantity_available: 120,
    image_url: "http://example.com/images/first_aid_supplies_v2.jpg",
  },
  {
    id: "prod_015",
    name: "Educational Kits",
    category: "Educational Supplies",
    description: "Interactive educational kits for hands-on learning.",
    cost: 30.0,
    supplier_id: "supplier_008",
    quantity_available: 200,
    image_url: "http://example.com/images/educational_kits_v2.jpg",
  },
  {
    id: "prod_016",
    name: "Hygiene Kits",
    category: "Health and Hygiene",
    description: "Comprehensive hygiene kits for families in need.",
    cost: 12.0,
    supplier_id: "supplier_006",
    quantity_available: 300,
    image_url: "http://example.com/images/hygiene_kits_v2.jpg",
  },
  {
    id: "prod_017",
    name: "Non-Perishable Food Packs",
    category: "Food and Nutrition",
    description: "Healthy non-perishable food packs for emergencies.",
    cost: 45.0,
    supplier_id: "supplier_007",
    quantity_available: 100,
    image_url: "http://example.com/images/non_perishable_food_packs_v2.jpg",
  },
  {
    id: "prod_018",
    name: "Children's Clothing",
    category: "Shelter and Clothing",
    description: "Comfortable clothing designed for children.",
    cost: 22.0,
    supplier_id: "supplier_008",
    quantity_available: 150,
    image_url: "http://example.com/images/childrens_clothing_v2.jpg",
  },
  {
    id: "prod_019",
    name: "Mobile Charging Stations",
    category: "Safety and Emergency",
    description: "Solar-powered mobile charging stations for on-the-go use.",
    cost: 120.0,
    supplier_id: "supplier_006",
    quantity_available: 40,
    image_url: "http://example.com/images/mobile_charging_stations_v2.jpg",
  },
  {
    id: "prod_020",
    name: "Bedding Sets",
    category: "Shelter and Clothing",
    description: "Cozy bedding sets with soft materials for comfort.",
    cost: 55.0,
    supplier_id: "supplier_007",
    quantity_available: 60,
    image_url: "http://example.com/images/bedding_sets_v2.jpg",
  },
  {
    id: "prod_021",
    name: "Portable Water Filters",
    category: "Health and Hygiene",
    description: "Compact water filters for outdoor use.",
    cost: 50.0,
    supplier_id: "supplier_005",
    quantity_available: 75,
    image_url: "http://example.com/images/portable_water_filters.jpg",
  },
  {
    id: "prod_022",
    name: "Travel First Aid Kit",
    category: "Health and Hygiene",
    description: "Travel-friendly first aid kit for emergencies on the go.",
    cost: 25.0,
    supplier_id: "supplier_008",
    quantity_available: 100,
    image_url: "http://example.com/images/travel_first_aid_kit.jpg",
  },
];
